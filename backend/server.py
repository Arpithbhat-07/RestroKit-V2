...
class CollectionProxy:
    ...
    async def update_one(self, filter_query=None, update=None):
        collection = await self._get_collection()
        return await collection.update_one(filter_query, update)
...
async def update_restaurant(data: Dict[str, Any], user=Depends(get_current_user), request: Request = None):
...
@api_router.put("/hero")
async def update_hero(data: Dict[str, Any], user=Depends(get_current_user), request: Request = None):
...
async def update_about(data: Dict[str, Any], user=Depends(get_current_user), request: Request = None):
...
async def update_settings(data: Dict[str, Any], user=Depends(get_current_user), request: Request = None):
